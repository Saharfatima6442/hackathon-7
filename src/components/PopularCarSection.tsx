      ...
      <section className="bg-gray-50 py-8">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-gray-900">Popular Car</h2>
            <a href="#" className="text-blue-500 hover:underline w[64px] h-[24px] text-[16px]">
              View All
            </a>
          </div>
            ...
            {cars.map((car) => (
              ...
              >
                ...
                <div className="flex justify-end">
                  <button className="text-red-500 hover:fill-red-500">
                    <svg
